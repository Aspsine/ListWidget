...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewItemViewHolder> {
    @NonNull
    ...
    @Override
    public RecyclerViewItemViewHolder onCreateViewHolder(ViewGroup viewGroup, int position) {
    ...
    public void onBindViewHolder(RecyclerViewItemViewHolder viewHolder, int position) {
        final ItemViewHolder itemViewHolder = viewHolder.getItemViewHolder();
